...
class IndeedPlugin(JobBoardPlugin):
    def __init__(
        ...
        scraper_config = load_scraper_config("indeed")
    ...
    def gather_jobs(self) -> list[JobListing]:
        ...
        with sync_playwright() as p:
            ...
            try:
                page.goto(self.search_filter_url or "https://www.indeed.com/jobs")
                page.wait_for_load_state("domcontentloaded")

                if self.search_filter_url:
                    # Non-interactive: the URL encodes the filters, so wait for the
                    # results cards to render instead of prompting for manual filters.
                    page.locator(
